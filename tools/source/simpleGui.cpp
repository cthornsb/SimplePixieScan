...
GuiWindow::GuiWindow(const TGWindow *p, const std::string &firstName_/*="group1"*/, const int &w/*=100*/, const int &h/*=100*/) : TGMainFrame(p, w, h, kMainFrame), isWaiting(false), isQuitting(false), valsIndex(0) {
	NewGroup(firstName_);
}
